...
import com.laughing.kotlin.util.UiUtil;
...
public abstract class BaseTitleFragment extends BaseFragment {
    ...
    protected void onBindViewBefore(View view) {
        ...
        ViewStub stub = (ViewStub) view.findViewById(R.id.lay_content);
        stub.setLayoutResource(getContentLayoutId());
        stub.inflate();
        contentView = view.findViewById(R.id.pic_view_id_after_inflate);
    }

    @Override
    protected void initView(View view) {
        super.initView(view);
        line1 = view.findViewById(R.id.title_line1);
        line2 = view.findViewById(R.id.title_line2);
        line3 = view.findViewById(R.id.title_line3);

        llRoot = (LinearLayout) view.findViewById(R.id.ll_basetitle_root);
        title = (RelativeLayout) view.findViewById(R.id.ll_basetitle);
        statusBar = (TextView) view.findViewById(R.id.status_bar);
        titleText = (TextView) view.findViewById(R.id.tv_basetitle_title);
        leftOneImage = (ImageView) view.findViewById(R.id.iv_left_one);
        leftTwoImage = (ImageView) view.findViewById(R.id.iv_left_two);
        rightOneImage = (ImageView) view.findViewById(R.id.iv_right_one);
        rightTextView = (TextView) view.findViewById(R.id.tv_right);
        rightTwoImage = (ImageView) view.findViewById(R.id.iv_right_two);
    ...
    protected void setStatusBarHeight() {
        statusBar.setHeight(UiUtil.getStatusBarHeight(getContext()));
    }
